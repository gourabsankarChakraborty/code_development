...
public class ApplicationDetailsRequest {
	...
	private List<CustomerContactRequest> customerContactList = new ArrayList<>();
	...
	public List<CustomerContactRequest> getCustomerContactList() {
		return customerContactList;
	}
	public void setCustomerContactList(List<CustomerContactRequest> customerContactList) {
